$version = "1.5.1, Jan 2021";
$mode = "coassembly";
$date = "Wed Mar  9 08:29:30 2022";

$installpath = "/cluster/projects/nn9745k/scripts/conda_envs/squeezemeta/SqueezeMeta";
...
$databasepath = "/cluster/projects/nn9745k/03_databases/SqueezeMeta/db";
...
$singletons      = 0;
$cleaning        = 1;
$cleaningoptions = "ILLUMINACLIP:NexteraPE-PE.fa:2:30:10 LEADING:3 TRAILING:3 SLIDINGWINDOW:4:15 MINLEN:36";
$mapper          = "bowtie";
...
$assembler          = "megahit";
$canumem            = NF;
$assembler_options    = "--k-min 29"; # "--k-min 33"; "--k-max 141"; "--k-step 22"
